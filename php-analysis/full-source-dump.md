...
# ==============================================================================
# 文件: php/class/multi_currency.php
# ==============================================================================
<?php
...
class MultiCurrency
{
    ...
    function Convert($strUSDCNY = false, $strHKDCNY = false) 
    {
...
# ==============================================================================
# 文件: php/class/year_month_day.php
# ==============================================================================
<?php
...
class DateImageFile extends PageImageFile
{
    ...
    {
		$this->strText .= $str.'：'.$strDate.' '.GetFontElement(number_format($fVal, 2), $this->strLineColor).GetHtmlNewLine();
    }
    ...
    function GetAll($strName, $strCompare)
    {
    	...
    	$str .= GetHtmlNewLine().$this->GetLink();
    	return $str;
	}
}
...
// https://kraneshares.com/product-json/?pid=7615&type=premium-discount&start=2025-08-18&end=2025-08-19
// https://kraneshares.com/resources/trading_history/2026_03_16_kweb_trading.history.csv
...
function GetInvescoNetValueUrl($strSymbol)
{
	...
	{
	case 'QQQ':
		return GetInvescoUrl('dng-api').'cache/v1/accounts/en_US/shareclasses/46090E103/prices?idType=cusip&variationType=priceListing&productType=ETF&productSubType=ETF';
	}
	return false;
}
...
# ==============================================================================
# 文件: php/sql/sqlstocktransaction.php
# ==============================================================================
<?php
require_once('sqltable.php');
...
class _QdiiReference extends FundReference
{
    ...
    function _getEstNetValue($est_ref, $strDate)
    {
        ...
        {
            //DebugString(__FUNCTION__.$est_ref->GetSymbol().' '.$strDate.' '.$str, true);
        	return $str;
        }
        return false;
    }
    ...
    function _getOfficialEstVal($strDate)
    {
		...
		if ($str = $this->_getEstNetValue($est_ref, $strDate))		return $str;
       	if (method_exists($est_ref, 'GetHoldingsDate'))		return strval($est_ref->_estNetValue($strDate));
    ...
    function EstNetValue()
    {
        ...
        {   // Load last value from database
            ...
            if ($record = $fund_est_sql->GetRecordNow($this->GetStockId()))
            {
        	    ...
        	    //$this->fOfficialNetValue = $this->GetQdiiValue($this->_getOfficialEstVal($this->strOfficialDate), $this->strOfficialCNY);
                //$this->UpdateEstNetValue();
            }
            else
            {
...
# ==============================================================================
# 文件: php/stock/stockprefetch.php
# ==============================================================================
<?php
...
//	$sym->SetTimeZone();
	...
	if (file_exists($strFileName))
	{
		...
		$strNetValueDate = UseSameDayNetValue($sym) ? $strDate : $his_sql->GetDatePrev($strStockId, $strDate);
		if (SqlGetNetValueByDate($strStockId, $strNetValueDate))		return false;
...
class StockGroup
{
    ...
    {
        $sym = $trans->ref;
        if ($sym->IsSymbolA() || $sym->IsSinaFutureCN() || $sym->GetSymbol() == 'fx_susdcnh')
        {
...
# ==============================================================================
# 文件: php/test/_commonupdatestock.php
# ==============================================================================
<?php
require_once('../account.php');
require_once('../externalurl.php');
...
# ==============================================================================
# 文件: php/test/updatechinastock.php
# ==============================================================================
<?php
...
# ==============================================================================
# 文件: php/test/updatesecondlisting.php
# ==============================================================================
<?php
require_once('_commonupdatestock.php');
...
# ==============================================================================
# 文件: php/tutorial/cramersrule.php
# ==============================================================================
<?php
...
# ==============================================================================
# 文件: php/tutorial/gaussianelimination.php
# ==============================================================================
<?php
...
# ==============================================================================
# 文件: php/tutorial/primenumber.php
# ==============================================================================
<?php
...
# ==============================================================================
# 文件: php/ui/_editcn.php
# ==============================================================================
<?php EchoNobody(); ?>
<body bgproperties=fixed leftmargin=0 topmargin=0 onLoad=OnLoad()>
<?php EchoBody(true, false); ?>
</body>
</html>


# ==============================================================================
# 文件: php/ui/ahparagraph.php
# ==============================================================================
<?php
...
# ==============================================================================
# 文件: php/ui/calibrationhistoryparagraph.php
# ==============================================================================
<?php
...
# ==============================================================================
# 文件: php/ui/commentparagraph.php
# ==============================================================================
<?php
...
# ==============================================================================
# 文件: php/ui/fundestparagraph.php
# ==============================================================================
<?php
//require_once('stocktable.php');
...
# ==============================================================================
# 文件: php/ui/fundhistoryparagraph.php
# ==============================================================================
<?php
require_once('stocktable.php');
...
# ==============================================================================
# 文件: php/ui/fundlistparagraph.php
# ==============================================================================
<?php
...
# ==============================================================================
# 文件: php/ui/fundpurchaseparagraph.php
# ==============================================================================
<?php
require_once('stocktable.php');
...
# ==============================================================================
# 文件: php/ui/fundshareparagraph.php
# ==============================================================================
<?php
require_once('stocktable.php');
...
# ==============================================================================
# 文件: php/ui/netvaluecloseparagraph.php
# ==============================================================================
<?php
require_once('stocktable.php');
...
# ==============================================================================
# 文件: php/ui/netvaluehistoryparagraph.php
# ==============================================================================
<?php
require_once('stocktable.php');
...
# ==============================================================================
# 文件: php/ui/portfolioparagraph.php
# ==============================================================================
<?php
require_once('stocktable.php');
...
# ==============================================================================
# 文件: php/ui/pricepoolparagraph.php
# ==============================================================================
<?php
...
# ==============================================================================
# 文件: php/ui/referenceparagraph.php
# ==============================================================================
<?php
require_once('stocktable.php');
...
# ==============================================================================
# 文件: php/ui/stockgroupparagraph.php
# ==============================================================================
<?php
require_once('stocktable.php');
...
# ==============================================================================
# 文件: php/ui/stockhistoryparagraph.php
# ==============================================================================
<?php
require_once('stocktable.php');
...
# ==============================================================================
# 文件: php/ui/tradingparagraph.php
# ==============================================================================
<?php
require_once('stocktable.php');
...
# ==============================================================================
# 文件: php/ui/transactionparagraph.php
# ==============================================================================
<?php
...
> 文件数: 26
> 行数: ~1,581
> 与股票分析功能的关系: 完全无关 (Palmmicro VoIP硬件公司时代的历史页面)
...
<meta name="description" content="Resources related with Palmmicro. Including open source VoIP software, service providers and other companies founded by former Palmmicro members.">
...
<script type="text/javascript">PalmmicroMenu("res");</script>
</TABLE>
</TD>
<td width=30 valign=top bgcolor=#66CC66>&nbsp;</td>
<td width=50 valign=top bgcolor=#ffffff>&nbsp;</td>
...
<table>
<tr><td class=THead><B>Open Source Software</B></td></tr>
<tr><td>Development <a href="apiguide.php">guide</a> of Palmmicro software API with <a href="../woody/blog/pa6488/20100211.php">BSD</a> license.
<br /><a href="http://www.asterisk.org" target=_blank>Asterisk</a> IP PBX.
<br />Software phone <a href="http://www.linphone.org" target=_blank>Linphone</a>.
<br />AR1688 software API <a href="http://sourceforge.net/projects/sdcc/" target=_blank>SDCC</a> <a name="sdcc">compiler</a>.
<br />Editor <a href="http://jedit.org" target=_blank>jEdit</a>.
<br />&nbsp;
</td></tr>

<tr><td class=THead><B>Service Providers</B></td></tr>
<tr><td><a href="sip2sip.html">SIP2SIP</a>
<br /><a href="voipdiscount.html">VoipDiscount</a> and VoipRaider
<br /><a href="voiptalk.html">VoIPtalk</a>
<br />&nbsp;
</td></tr>

<tr><td class=THead>Gallery</td></tr>
<tr><td>Oct 24, 2008. Palmmicro <a href="20081024.html">office</a> images.
<br />Jan 11, 2003. Palmmicro <a href="20030111.html">images</a>.
<br />&nbsp;
</td></tr>

<tr><td class=THead><B>Web Development</B></td></tr>
<tr><td><a href="translation.html">Translation guidelines</a>.
<br /><a href="format.html">Web page format</a>.
<br /><a href="https://www.google.com/analytics/web" target=_blank>Google Analytics</a>, the free service to track web visitors.
<br /><a href="https://www.google.com/adsense/app" target=_blank>Google Adsense</a>, a way to make money from <a href="../woody/blog/entertainment/20110509.php">Google</a>.
<br />&nbsp;
</td></tr>

<tr><td class=THead>Other <a name="company">Companies</a> Founded by Former Centrality Members</td></tr>
<tr><td>Inspired by the success stories of Dr Wang,
nearly all <a href="../woody/blog/palmmicro/20080326.php">Palmmicro</a> early employees started their own businesses after leaving Centrality, <a href="../woody/blog/entertainment/20070813.php">SiRF</a> or <a href="../woody/blog/entertainment/20090219.php">CSR</a>.
<br /><a href="http://www.olinkstar.com" target=_blank>OLinkStar</a>
<br /><a href="http://www.unicorecomm.com" target=_blank>UNICORE</a>
<br /><a href="http://www.striiv.com" target=_blank>Striiv</a>
<br /><a href="http://www.zongmutech.com" target=_blank>ZongMu Technology</a>
<br />&nbsp;
</td></tr>
...
## File: res/indexcn.html

<html>
<head>
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
<title>资源共享</title>
<meta name="description" content="跟Palmmicro相关的网络资源, 包括开源的VoIP软件Asterisk, 软件电话和SDCC编译器, VoIP运营商以及以前Palmmicro员工创办的其它公司.">
<link href="../common/style.css" rel="stylesheet" type="text/css" />
<script src="../js/filetype.js"></script>
<script src="../js/copyright.js"></script>
<script src="../js/nav.js"></script>
...
<table>
<tr><td class=THead><B>开放源代码软件</B></td></tr>
<tr><td><a href="../woody/blog/pa6488/20100211cn.php">BSD</a>版权协议的Palmmicro软件API开发<a href="apiguidecn.php">指南</a>.
<br /><a href="http://www.asterisk.org" target=_blank>Asterisk</a> IP电话交换机. 
<br />软件电话<a href="http://www.linphone.org" target=_blank>Linphone</a>. 
<br />AR1688软件开发包使用的<a href="http://sourceforge.net/projects/sdcc/" target=_blank>SDCC</a><a name="sdcc">编译器</a>. 
<br />编辑器<a href="http://jedit.org" target=_blank>jEdit</a>. 
<br />&nbsp;
</td></tr>

<tr><td class=THead><B>运营商</B></td></tr>
<tr><td><a href="sip2sipcn.html">SIP2SIP</a>
<br /><a href="voipdiscountcn.html">VoipDiscount</a>和VoipRaider
<br /><a href="voiptalkcn.html">VoIPtalk</a>
<br />&nbsp;
</td></tr>

<tr><td class=THead>图片</td></tr>
<tr><td>2008年10月24日Palmmicro<a href="20081024cn.html">办公室</a>图片. 
<br />2003年1月11日Palmmicro<a href="20030111cn.html">图片</a>. 
<br />&nbsp;
</td></tr>

<tr><td class=THead><B>网站制作</B></td></tr>
<tr><td><a href="translationcn.html">翻译对照</a>.
<br /><a href="formatcn.html">网页格式</a>. 
<br /><a href="https://www.google.com/analytics/web" target=_blank>Google Analytics</a>, 分析网络来访者的免费工具. 
<br /><a href="https://www.google.com/adsense/app" target=_blank>Google Adsense</a>, 让网站自己从<a href="../woody/blog/entertainment/20110509cn.php">Google</a>赚钱. 
<br />&nbsp;
</td></tr>

<tr><td class=THead>Centrality前员工创办的其它<a name="company">公司</a></td></tr>
<tr><td>在<a href="../woody/blog/palmmicro/20061123cn.php">王老板</a>成功故事的影响下, 差不多所有<a href="../woody/blog/palmmicro/20080326cn.php">Palmmicro</a>的早期员工都在离开Centrality, <a href="../woody/blog/entertainment/20070813cn.php">SiRF</a>或者<a href="../woody/blog/entertainment/20090219cn.php">CSR</a>后开了自己的公司. 
<br /><a href="http://www.olinkstar.com" target=_blank>东方联星</a>
<br /><a href="http://www.unicorecomm.com" target=_blank>和芯星通</a>
<br /><a href="http://www.striiv.com" target=_blank>Striiv</a>
<br /><a href="http://www.zongmutech.com" target=_blank>纵目科技</a>
<br />&nbsp;
</td></tr>
...
## File: res/format.html

<html>
<head>
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
<title>Web Page Format</title>
<meta name="description" content="This page is to log different font and color combinations used in palmmicro.com web development.">
<link href="../common/style.css" rel="stylesheet" type="text/css" />
<script src="../js/filetype.js"></script>
<script src="../js/copyright.js"></script>
<script src="../js/nav.js"></script>
...
<td width=120 valign=top bgcolor=#66CC66>
<TABLE width=120 border=0 cellPadding=5 cellSpacing=0>
<script type="text/javascript">NavLoopWeb();</script>
</TABLE>
</TD>
<td width=30 valign=top bgcolor=#66CC66>&nbsp;</td>
<td width=50 valign=top bgcolor=#ffffff>&nbsp;</td>
...
<table>
<tr><td class=THead><B>Web Page Format</B></td></tr>
<tr><td>&nbsp;
<br /><b>Font</b>
<!--<br />People's name: <u>Alex</u>-->
<br />File name and directory: C:\SDCC\src\<B>font.c</B>
<br />Function name: <i>TaskOutgoingData</i>
<br />Compiler define: <B><i>SYS_IVR_G729</i></B>
<br />&nbsp;
<br /><b><font color=indigo>Color</font></b>
<br />Setting option: <font color=blue>Automatically Adjust Clock for Daylight Saving Changes</font> 
<br />Quote and source: <font color=gray>There's no importance whatsoever. I'm just doing it for the fun of it.</font>
<br />Blog update: <font color=magenta>Updated on Feb 13, 2008</font>
<br />Data type: <font color=olive>BOOLEAN</font>
<br />Version number: <font color=orange>1.21</font>
<br />Error and serious warning message: <font color=red>Not a valid Win32 application</font> 
<br />&nbsp;
<!--<br /><b><a href="http://optimizr.com" target=_blank>optimizr.com</a></b>
<br /><i>Long Meta-Description:</i> 
<br /><i>Short Meta-Description:</i> 
The meta-description shows a small sample of the content on the page and should not exceed 156 characters (including spaces), to ensure that Google will show them in the searchresult pages.
This potential is not used to its fullest potential by some pages, because their meta-description is too short.
<br /><i>Identical Title-Tag:</i>  
Make sure you have an individual title-tag on each page. If multiple pages use the same title, Google might think of them as duplicate content. 
The content of the title-element on the page is a strong ranking-factor and should always be present. Each URL should have its own, unique title with the keyword, for which the page (URL) is supposed to rank, at the beginning of title. Optimising the title-element is part of the so-called "SEO-basics".
-->
</td></tr>
</table>
...
## File: res/formatcn.html

<html>
<head>
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
<title>网页格式</title>
<meta name="description" content="好记性不如烂笔头. 这个页面用来记录palmmicro.com网站开发过程中使用的字体和颜色的格式组合. 没有美工基础无法把网站做得多好看只是力求统一格式让人看上去清晰易懂.">
<link href="../common/style.css" rel="stylesheet" type="text/css" />
<script src="../js/filetype.js"></script>
<script src="../js/copyright.js"></script>
<script src="../js/nav.js"></script>
...
<table>
<tr><td class=THead><B>网页格式</B></td></tr>
<tr><td>&nbsp;
<br /><b>字体</b>
<!--<br />人名: <u>Alex</u>-->
<br />文件名和目录: C:\SDCC\src\<B>font.c</B>
<br />函数名: <i>TaskOutgoingData</i>
<br />编译定义: <B><i>SYS_IVR_G729</i></B>
<br />&nbsp;
<br /><b><font color=indigo>颜色</font></b>
<br />设置选项: <font color=blue>根据夏时制自动调节时钟</font> 
<br />引用和来源: <font color=gray>There's no importance whatsoever. I'm just doing it for the fun of it.</font>
<br />网络日志内容更新: <font color=magenta>2008年2月13日更新</font>
<br />数据类型: <font color=olive>BOOLEAN</font>
<br />版本号: <font color=orange>1.21</font>
<br />错误和严重警告信息: <font color=red>Not a valid Win32 application</font> 
</td></tr>
</table>
...
## File: res/translation.html

<html>
<head>
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
<title>Translation Guidelines</title>
<meta name="description" content= "English to Chinese translation guidelines used in palmmicro.com, common phrases including Voice over Internet Protocol etc.">
<link href="../common/style.css" rel="stylesheet" type="text/css" />
<script src="../js/filetype.js"></script>
<script src="../js/copyright.js"></script>
<script src="../js/nav.js"></script>
...
<table>
<tr><td class=THead><B>Translation Guidelines</B></td></tr>
<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
<tr><td><b>Word keep as it is:</b>
<br />API: <em>Application Programming Interface</em>
<br />ASCII: <em>American Standard Code for Information Interchange</em>
<br />BOM: <em>Bill Of Materials</em>
<br />DSP: <em>Digital Signal Processor</em>
<br />LCD: <em>Liquid Crystal Display</em>
<br />LED: <em>Light-Emitting Diode</em>
<br />MIPS: <em>Million Instructions per Second</em>
<br />RTOS: <em>Real-Time Operating System</em>
<br />VoIP: <em>Voice over Internet Protocol</em>
</td></tr>
<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
<tr><td><b>Fiexed words:</b>
<br />Character LCD
<br />Bank switching
<br />IP phone
<br />Program flash
<br />Safe mode
<br />Software API
<br />Yahoo Web Hosting, the <a name="webhosting">service provider</a> of this web site.
</td></tr>
</table>
...
## File: res/translationcn.html

<html>
<head>
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
<title>翻译对照</title>
<meta name="description" content="跟本网站相关的中英文翻译对照, 来源, 外部链接以及简单的说明. 词条包括Voice over Internet Protocol, Yahoo Web Hosting等.">
<link href="../common/style.css" rel="stylesheet" type="text/css" />
<script src="../js/filetype.js"></script>
<script src="../js/copyright.js"></script>
<script src="../js/nav.js"></script>
...
<table>
<tr><td class=THead><B>翻译对照</B></td></tr>
<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
<tr><td><b>保持原样不翻译的: </b>
<br />API: <em>Application Programming Interface</em> 应用程序接口
<br />ASCII: <em>American Standard Code for Information Interchange</em> 美国标准信息交换码
<br />BOM: <em>Bill Of Materials</em> 物料成本
<br />DSP: <em>Digital Signal Processor</em> 数字信号处理器
<br />LCD: <em>Liquid Crystal Display</em> 液晶显示屏
<br />LED: <em>Light-Emitting Diode</em> 发光二极管
<br />MIPS: <em>Million Instructions per Second</em> 每秒百万条指令
<br />RTOS: <em>Real-Time Operating System</em> 实时操作系统
<br />VoIP: <em>Voice over Internet Protocol</em> 基于网络协议传送语音
</td></tr>
<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
<tr><td><b>固定词组翻译的: </b>
<br />Character LCD: <em>字符型LCD</em>
<br />Bank switching: <em>页面切换</em>
<br />IP phone: <em>网络电话</em>
<br />Program flash: <em>程序存储器</em>
<br />Safe mode: <em>安全模式</em>
<br />Software API: <em>软件API</em>
<br />Yahoo Web Hosting: <em>Yahoo网站服务</em> 本网站的<a name="webhosting">服务商</a> 
</td></tr>
</table>
...
## File: res/sip2sip.html

<html>
<head>
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
<title>SIP2SIP Service</title>
<meta name="description" content="SIP2SIP (www.sip2sip.info) VoIP service introduction and reference AR1688 settings to use the service.">
<link href="../common/style.css" rel="stylesheet" type="text/css" />
<script src="../js/filetype.js"></script>
<script src="../js/copyright.js"></script>
<script src="../js/nav.js"></script>
...
<td width=120 valign=top bgcolor=#66CC66>
<TABLE width=120 border=0 cellPadding=5 cellSpacing=0>
<script type="text/javascript">NavLoopService();</script>
</TABLE>
</TD>
<td width=30 valign=top bgcolor=#66CC66>&nbsp;</td>
<td width=50 valign=top bgcolor=#ffffff>&nbsp;</td>
...
<table>
<tr><td class=THead><B>SIP2SIP Service</B></td></tr>
<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
<tr><td>Web: <a href="http://www.sip2sip.info" target=_blank>www.sip2sip.info</a>
<br />
<br />SIP Address: palmmicro@sip2sip.info  
<br />Username: palmmicro  
<br />Password: 28y62d95hw  
<br />Domain/Realm: sip2sip.info  
<br />Outbound Proxy: proxy.sipthor.net  
<br />SIP Alias: 33011668@sip2sip.info
<br />
<br />SIP alias like <font color=blue>33011668</font> can be added in the <font color=blue>Identity</font> web page.
By adding an all-digit alias, other user with a hardware phone like <a href="../ar1688/user/gp1266.html">GP1266</a> can dial the number to call <font color=blue>palmmicro</font>.
AR1688 device user can also put <font color=blue>palmmicro</font> in <font color=blue>Hot Line Number</font> option field or save <font color=blue>palmmicro</font> to phone book and use quick dial to call.
<br />
<br />Call Test: 3333
<br />Echo Test: 4444
<br />
<br />When using <a href="http://icanblink.com/" target=_blank>Blink</a> and AR1688 device together in this free service, there is a known problem:
<br />1. If using <b>Blink</b> default configuration, the call is connected in <a href="../woody/blog/ar1688/20071031.php">speex</a> 8k codec, which is ok when <b>Blink</b> call AR1688,
and no voice when AR1688 call <b>Blink</b>. Maybe there is a bug with speex payload type negotiation
<br />2. If remove speex codec from <b>Blink</b>'s <font color=blue>preference</font> menu, the call is connected in PCMU, which is ok on both sides.
<br />
<br /><a href="../ar1688/settings.html">AR1688</a> reference <a href="../ar1688/settings/sip2sip_sip_us.html" target=_blank>setting</a>
</td></tr>
</table>
...
## File: res/sip2sipcn.html

<html>
<head>
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
<title>SIP2SIP服务</title>
<meta name="description" content="SIP2SIP(www.sip2sip.info)VoIP服务和使用这个服务的AR1688参考设置. 在这个服务下, speex会导致单通, 跟AR1688通话时候要禁用.">
<link href="../common/style.css" rel="stylesheet" type="text/css" />
<script src="../js/filetype.js"></script>
<script src="../js/copyright.js"></script>
<script src="../js/nav.js"></script>
...
<table>
<tr><td class=THead><B>SIP2SIP服务</B></td></tr>
<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
<tr><td>网站: <a href="http://www.sip2sip.info" target=_blank>www.sip2sip.info</a>
<br />
<br />SIP地址: palmmicro@sip2sip.info  
<br />用户名: palmmicro  
<br />密码: 28y62d95hw  
<br />Domain/Realm: sip2sip.info  
<br />Outbound Proxy: proxy.sipthor.net  
<br />SIP别名: 33011668@sip2sip.info
<br />
<br />SIP别名例如<font color=blue>33011668</font>可以在<font color=blue>Identity</font>网页中添加,
这样其它使用硬件电话例如<a href="../ar1688/user/gp1266cn.html">GP1266</a>的用户可以拨打这个全数字号码来呼叫<font color=blue>palmmicro</font>用户.
AR1688设备用户也可以把<font color=blue>palmmicro</font>存在<font color=blue>热线号码</font>设置选项中或者把<font color=blue>palmmicro</font>保存到电话号码本中用快速拨号呼叫. 
<br />
<br />呼叫测试: 3333
<br />回声测试: 4444
<br />
<br />在这个免费服务中同时使用<a href="http://icanblink.com/" target=_blank>Blink</a>和AR1688设备时, 有已知问题: 
<br />1. 用<b>Blink</b>的缺省配置, 连通后使用<a href="../woody/blog/ar1688/20071031cn.php">speex</a> 8k编解码器. 当<b>Blink</b>呼叫AR1688时正常, 当AR1688呼叫<b>Blink</b>时会没有声音.
可能在协商speex payload type的时候有问题. 
<br />2. 把speex从<b>Blink</b>的<font color=blue>preference</font>菜单中取消后, 通话使用PCMU, 两边呼叫都正常. 
<br />
<br /><a href="../ar1688/settingscn.html">AR1688</a>参考<a href="../ar1688/settings/sip2sip_sip_us.html" target=_blank>设置</a>
</td></tr>
</table>
...
## File: res/voipdiscount.html

<html>
<head>
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
<title>VoipDiscount Service</title>
<link href="../common/style.css" rel="stylesheet" type="text/css" />
<script src="../js/filetype.js"></script>
<script src="../js/copyright.js"></script>
<script src="../js/nav.js"></script>
...
<table>
<tr><td class=THead><B>VoipDiscount Service</B></td></tr>
<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
<tr><td>Web: <a href="http://www.voipdiscount.com" target=_blank>www.voipdiscount.com</a>
<br />
<br />Software configuration general
<br />SIP port: 5060
<br />Registrar: sip.voipdiscount.com
<br />Proxy server: sip.voipdiscount.com
<br />Account name: your VoipDiscount username
<br />Password: your VoipDiscount password
<br />Stunserver (option): stun.voipdiscount.com
<br />
<br />One common question about this free service is, how to call another user with username like wender.reis instead of a phone number. This problem can be solved by saving the username in phone book and using quick dial. With PA1688, after pickup handset, press quick dial key, do not forget to press # to dial out.
<br />
<br />VoipRaider(<a href="http://www.voipraider.com" target=_blank>www.voipraider.com</a>) shares the same features with VoipDiscount, reference settings can also be applied to VoipRaider just by changed the domain name.
<br />
<br /><a href="../ar1688/settings.html">AR1688</a> reference <a href="../ar1688/settings/voipdiscount_sip_us.html" target=_blank>setting</a> <a href="../ar1688/settings/voipdiscount_phonebook.html" target=_blank>phone book</a>
<br /><a href="../pa1688/settings.html">PA1688</a> reference <a href="../pa1688/settings/voipdiscount_sip_us.html" target=_blank>setting</a> <a href="../pa1688/settings/voipdiscount_phonebook.html" target=_blank>phone book</a>
</td></tr>
</table>
...
## File: res/voipdiscountcn.html

<html>
<head>
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
<title>VoipDiscount服务</title>
<link href="../common/style.css" rel="stylesheet" type="text/css" />
<script src="../js/filetype.js"></script>
<script src="../js/copyright.js"></script>
<script src="../js/nav.js"></script>
...
<table>
<tr><td class=THead><B>VoipDiscount服务</B></td></tr>
<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
<tr><td>网站: <a href="http://www.voipdiscount.com" target=_blank>www.voipdiscount.com</a>
<br />
<br />通用软件配置如下
<br />SIP端口: 5060
<br />Registrar: sip.voipdiscount.com
<br />Proxy server: sip.voipdiscount.com
<br />帐号: 你的VoipDiscount用户名
<br />密码: 你的VoipDiscount密码
<br />Stunserver (可选项): stun.voipdiscount.com
<br />
<br />这个免费服务有个常见问题, 如何呼叫一个用户名是wender.reis而不是普通号码的用户. 解决的办法是, 把用户名保存到号码本中, 通过快速拨号呼出. 对PA1688而言, 摘机后按快速拨号, 最后别忘记按#键呼出. 
<br />
<br />VoipRaider(<a href="http://www.voipraider.com" target=_blank>www.voipraider.com</a>)看上去跟VoipDiscount的特征一致. 参考设置同样可以用于VoipRaider, 改相应域名即可. 
<br />
<br /><a href="../ar1688/settingscn.html">AR1688</a>参考<a href="../ar1688/settings/voipdiscount_sip_us.html" target=_blank>设置</a> <a href="../ar1688/settings/voipdiscount_phonebook.html" target=_blank>号码本</a>
<br /><a href="../pa1688/settingscn.html">PA1688</a>参考<a href="../pa1688/settings/voipdiscount_sip_us.html" target=_blank>设置</a> <a href="../pa1688/settings/voipdiscount_phonebook.html" target=_blank>号码本</a>
</td></tr>
</table>
...
## File: res/voiptalk.html

<html>
<head>
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
<title>VoIPtalk Service</title>
<link href="../common/style.css" rel="stylesheet" type="text/css" />
<script src="../js/filetype.js"></script>
<script src="../js/copyright.js"></script>
<script src="../js/nav.js"></script>
...
<table>
<tr><td class=THead><B>VoIPtalk Service</B></td></tr>
<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
<tr><td>Web: <a href="http://www.voiptalk.org" target=_blank>www.voiptalk.org</a>
<br>Thank you for joining VoIPtalk! You can now start making calls to other VoIPtalk subscribers and VoIP networks for FREE and make low-cost calls to any destination in the world. To make calls to regular (PSTN) telephones you will need to purchase credit. Our standard service is prepaid enabling you to keep a close eye on your call expenditure.
<br>Your VoIP setup details are:
<br>VoIPtalk ID: 81256968
<br>VoIP Domain/Registrar: voiptalk.org
<br>Outbound Proxy: nat.voiptalk.org:5065
<br>You can retrieve your VoIPtalk password at: <a href="http://www.voiptalk.org/account" target=_blank>www.voiptalk.org/account</a>. No other settings (eg STUN, port forwarding, NAT IP) are required!
<br>
<br><a href="../ar1688/settings.html">AR1688</a> reference <a href="../ar1688/settings/voiptalk_sip_us.html" target=_blank>setting</a>
<br><a href="../pa1688/settings.html">PA1688</a> reference <a href="../pa1688/settings/voiptalk_sip_us.html" target=_blank>setting</a>
</td></tr>
</table>
...
## File: res/voiptalkcn.html

<html>
<head>
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
<title>VoIPtalk服务</title>
<link href="../common/style.css" rel="stylesheet" type="text/css" />
<script src="../js/filetype.js"></script>
<script src="../js/copyright.js"></script>
<script src="../js/nav.js"></script>
...
<table>
<tr><td class=THead><B>VoIPtalk服务</B></td></tr>
<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
<tr><td>网站: <a href="http://www.voiptalk.org" target=_blank>www.voiptalk.org</a>
<br>欢迎加入VoIPtalk! 现在你可以开始跟其它VoIPtalk用户免费通话, 并且可以低价拨打全世界任何电话. 拨打普通(PSTN)电话需要购买话费, 我们标准服务为预付费. 
<br>具体VoIP设置如下: 
<br>VoIPtalk ID: 81256968
<br>VoIP Domain/Registrar: voiptalk.org
<br>Outbound Proxy: nat.voiptalk.org:5065
<br>你的VoIPtalk密码可以从<a href="http://www.voiptalk.org/account" target=_blank>www.voiptalk.org/account</a>得到. 不需要其它设置(例如STUN, port forwarding, NAT IP)! 
<br>
<br><a href="../ar1688/settingscn.html">AR1688</a>参考<a href="../ar1688/settings/voiptalk_sip_cn.html" target=_blank>设置</a>
<br><a href="../pa1688/settingscn.html">PA1688</a>参考<a href="../pa1688/settings/voiptalk_sip_cn.html" target=_blank>设置</a>
</td></tr>
</table>
...
## File: res/sipphone.html

<html>
<head>
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
<title>SIPphone Service</title>
<meta name="description" content="SIPphone Gizmo5 (www.sipphone.com) VoIP service introduction, reference PA1688 and AR1688 settings to use the service.">
<link href="../common/style.css" rel="stylesheet" type="text/css" />
<script src="../js/filetype.js"></script>
<script src="../js/copyright.js"></script>
<script src="../js/nav.js"></script>
...
<table>
<tr><td class=THead><B>SIPphone Service</B></td></tr>
<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
<tr><td>Web: www.sipphone.com (<a href="../woody/blog/ar1688/20110403.php">Discontinued</a>)
<br>Proxy Server (Host): proxy01.sipphone.com
<br>Proxy Server (IP): 198.65.166.131
<br>Registration Server: proxy01.sipphone.com
<br>SIP Port (UDP): 5060
<br>STUN Server: stun01.sipphone.com
<br>STUN Port: 3478
<br>User ID: 17471115555 (replacing with your 1747)
<br>Auth ID: 17471115555 (replacing with your 1747)
<br>Password: (your gizmo5 password)
<br>
<br><a href="../ar1688/settings.html">AR1688</a> reference <a href="../ar1688/settings/sipphone_sip_us.html" target=_blank>setting</a>
<br><a href="../pa1688/settings.html">PA1688</a> reference <a href="../pa1688/settings/sipphone_sip_us.html" target=_blank>setting</a>
</td></tr>
</table>
...
## File: res/sipphonecn.html

<html>
<head>
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
<title>SIPphone服务</title>
<meta name="description" content="SIPphone Gizmo5 (www.sipphone.com) VoIP服务介绍和说明, 以及使用这个服务的PA1688和AR1688设备的参考设置.">
<link href="../common/style.css" rel="stylesheet" type="text/css" />
<script src="../js/filetype.js"></script>
<script src="../js/copyright.js"></script>
<script src="../js/nav.js"></script>
...
<table>
<tr><td class=THead><B>SIPphone服务</B></td></tr>
<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
<tr><td>网站: www.sipphone.com (<a href="../woody/blog/ar1688/20110403cn.php">已停止服务</a>)
<br>Proxy Server (Host): proxy01.sipphone.com
<br>Proxy Server (IP): 198.65.166.131
<br>Registration Server: proxy01.sipphone.com
<br>SIP Port (UDP): 5060
<br>STUN Server: stun01.sipphone.com
<br>STUN Port: 3478
<br>User ID: 17471115555 (用你自己的1747替换)
<br>Auth ID: 17471115555 (用你自己的1747替换)
<br>Password: (你的gizmo5密码)
<br>
<br><a href="../ar1688/settingscn.html">AR1688</a>参考<a href="../ar1688/settings/sipphone_sip_cn.html" target=_blank>设置</a>
<br><a href="../pa1688/settingscn.html">PA1688</a>参考<a href="../pa1688/settings/sipphone_sip_us.html" target=_blank>设置</a>
</td></tr>
</table>
...
## File: res/20030111.html

<html>
<head>
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
<title>Palmmicro Images</title>
<link href="../common/style.css" rel="stylesheet" type="text/css" />
<script src="../js/filetype.js"></script>
<script src="../js/copyright.js"></script>
<script src="../js/nav.js"></script>
...
<td width=120 valign=top bgcolor=#66CC66>
<TABLE width=120 border=0 cellPadding=5 cellSpacing=0>
<script type="text/javascript">NavLoopImage();</script>
</TABLE>
</TD>
<td width=30 valign=top bgcolor=#66CC66>&nbsp;</td>
<td width=50 valign=top bgcolor=#ffffff>&nbsp;</td>
...
<table>
<tr><td class=THead><B>Jan 11 2003 Palmmicro Images</B></td></tr>
<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
<tr><td><a href="../woody/index.php">Woody</a> <a href="../woody/myphoto/2003/home.jpg" target=_blank>Large</a></td></tr>
<tr><td><img src=../woody/myphoto/2003/home_s.jpg></td></tr>
<tr><td>Li Jing <a href="20030111/lijing.jpg" target=_blank>Large</a></td></tr>
<tr><td><img src=20030111/lijing_s.jpg></td></tr>
<tr><td>Kingon <a href="20030111/kingon.jpg" target=_blank>Large</a></td></tr>
<tr><td><img src=20030111/kingon_s.jpg></td></tr>
<tr><td>Li Yajing <a href="20030111/liyajing.jpg" target=_blank>Large</a></td></tr>
<tr><td><img src=20030111/liyajing_s.jpg></td></tr>
<tr><td>Shen Wei <a href="20030111/shenwei.jpg" target=_blank>Large</a></td></tr>
<tr><td><img src=20030111/shenwei_s.jpg></td></tr>
<tr><td>Zheng Shanshan <a href="20030111/zhengshanshan.jpg" target=_blank>Large</a></td></tr>
<tr><td><img src=20030111/zhengshanshan_s.jpg></td></tr>
<tr><td>Andy <a href="20030111/andy.jpg" target=_blank>Large</a></td></tr>
<tr><td><img src=20030111/andy_s.jpg></td></tr>
</table>
...
## File: res/20030111cn.html

<html>
<head>
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
<title>Palmmicro图片</title>
<link href="../common/style.css" rel="stylesheet" type="text/css" />
<script src="../js/filetype.js"></script>
<script src="../js/copyright.js"></script>
<script src="../js/nav.js"></script>
...
<table>
<tr><td class=THead><B>2003年1月11日Palmmicro图片</B></td></tr>
<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
<tr><td><a href="../woody/indexcn.php">林蓉榕</a> <a href="../woody/myphoto/2003/home.jpg" target=_blank>大图</a></td></tr>
<tr><td><img src=../woody/myphoto/2003/home_s.jpg></td></tr>
<tr><td>李敬 <a href="20030111/lijing.jpg" target=_blank>大图</a></td></tr>
<tr><td><img src=20030111/lijing_s.jpg></td></tr>
<tr><td>李国伟 <a href="20030111/kingon.jpg" target=_blank>大图</a></td></tr>
<tr><td><img src=20030111/kingon_s.jpg></td></tr>
<tr><td>李雅菁 <a href="20030111/liyajing.jpg" target=_blank>大图</a></td></tr>
<tr><td><img src=20030111/liyajing_s.jpg></td></tr>
<tr><td>沈薇 <a href="20030111/shenwei.jpg" target=_blank>大图</a></td></tr>
<tr><td><img src=20030111/shenwei_s.jpg></td></tr>
<tr><td>郑姗姗 <a href="20030111/zhengshanshan.jpg" target=_blank>大图</a></td></tr>
<tr><td><img src=20030111/zhengshanshan_s.jpg></td></tr>
<tr><td>Andy <a href="20030111/andy.jpg" target=_blank>大图</a></td></tr>
<tr><td><img src=20030111/andy_s.jpg></td></tr>
</table>
...
## File: res/20081024.html

<html>
<head>
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
<title>Palmmicro Office Images</title>
<link href="../common/style.css" rel="stylesheet" type="text/css" />
<script src="../js/filetype.js"></script>
<script src="../js/copyright.js"></script>
<script src="../js/nav.js"></script>
...
<table>
<tr><td class=THead><B>Oct 24 2008 Palmmicro Office Images</B></td></tr>
<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
<tr><td>Picture from outside. <a href="20081024/office.jpg" target=_blank>Large</a></td></tr>
<tr><td><img src=20081024/office_s.jpg></td></tr>
<tr><td>Inside. <a href="20081024/office2.jpg" target=_blank>Large</a></td></tr>
<tr><td><img src=20081024/office2_s.jpg></td></tr>
</table>
...
## File: res/20081024cn.html

<html>
<head>
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
<title>Palmmicro办公室图片</title>
<link href="../common/style.css" rel="stylesheet" type="text/css" />
<script src="../js/filetype.js"></script>
<script src="../js/copyright.js"></script>
<script src="../js/nav.js"></script>
...
<table>
<tr><td class=THead><B>2008年10月24日Palmmicro办公室图片</B></td></tr>
<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
<tr><td>从外往里 <a href="20081024/office.jpg" target=_blank>大图</a></td></tr>
<tr><td><img src=20081024/office_s.jpg></td></tr>
<tr><td>从里往外 <a href="20081024/office2.jpg" target=_blank>大图</a></td></tr>
<tr><td><img src=20081024/office2_s.jpg></td></tr>
</table>
...
<td width=120 valign=top bgcolor=#66CC66>
<TABLE width=120 border=0 cellPadding=5 cellSpacing=0>
<script type="text/javascript">ResMenu(0, 0);</script>
</TABLE>
</TD>
<td width=30 valign=top bgcolor=#66CC66>&nbsp;</td>
<td width=50 valign=top bgcolor=#ffffff>&nbsp;</td>
...
## File: res/apiguidecn.html


---

## File: apiguide/apiguide.js
